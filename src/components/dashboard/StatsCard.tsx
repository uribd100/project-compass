  ...
  return <div className="card-elevated p-6 animate-fade-in">
      <div className="flex items-start justify-between">
        <div className="flex-1">
          <p className="text-sm font-medium border-primary bg-primary text-secondary-foreground">{title}</p>
          <p className="text-2xl font-bold mt-2 bg-primary text-secondary">{value}</p>
